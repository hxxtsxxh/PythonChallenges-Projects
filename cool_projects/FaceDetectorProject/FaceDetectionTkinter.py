...
title_label = Label(root, text='Face Detection AI', font='helvetica 40 bold', bg="#01A7C2", fg='#EAEBED').pack()

webcam_btn = Button(root, text='Webcam Face Detection', font='helvetica 20', bg="#0B1D51", fg='#EAEBED', padx=1,
                    command=webcam_detection).place(x=289, y=210)

img_btn = Button(root, text='  Image Face Detection  ', font='helvetica 20', bg="#0B1D51", fg='#EAEBED', padx=1,
                 command=img_detection).place(x=289, y=300)
